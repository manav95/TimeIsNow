...
export default function AboutUs({ title, subtitle, dark, id, slides, onboardEnabled, onboard }) {
    return (
      <div className={"section" + (dark ? " section-dark" : "")}>
        <div className="section-content" id={id}>
          ...
          dragEnabled>
         <Slider>
          <Slide index={0}><div class="flexbox-container"><CarouselArrow class="arrow left" label="previous"></CarouselArrow>Time Is Now is an organization and movement of the people and for the people that creates peaceful solutions benefiting all life forms on the planet. TIN works with socially and environmentally conscious organizations, communities and movements, and elevates them through our various platforms. In doing so we draw forth solidarity, powerful unified action and together make strides towards world peace. <CarouselArrow class="arrow right" label="forward"></CarouselArrow></div></Slide>
